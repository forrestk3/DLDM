...
#		print dir(msg)
	...
	def initPath(self):
		#first line is 7sw-4-4 topology
		print 'initPath'
		paths={
		'1-7':[(1,3,7),(1,2,5,7),(1,2,3,7),(1,3,5,7),(1,4,3,7),(1,4,6,7),(1,2,5,3,7),(1,2,3,5,7),(1,3,2,5,7),(1,3,4,6,7),(1,4,3,5,7),(1,2,3,5,7),(1,4,3,2,5,7)
		],
...
#					print int(round(time.time() * 1000))
	...
	def getPath(self,src,dst):
		...
		mmp={'a':10,'b':11,'c':12,'d':13,'e':14,'f':15}
		...
		dip=dst
		if(s>t):
			#switch src dst->getpath->reverse path
			sip=dst
			dip=src
		ipstr=sip+'>'+dip
		print ipstr
