...
net.addLink( s2, s5, 2, 1 ,bw=1,delay='2ms',max_queue_size=100,loss=0,use_htb=True)
net.addLink( s3, s6, 2, 1 ,bw=1,delay='2ms',max_queue_size=100,loss=0,use_htb=True)
net.addLink( s4, s7, 2, 1 ,bw=1,delay='2ms',max_queue_size=100,loss=0,use_htb=True)
net.addLink( s5, s8, 2, 5 ,bw=1,delay='2ms',max_queue_size=100,loss=0,use_htb=True)
net.addLink( s6, s8, 2, 6 ,bw=1,delay='2ms',max_queue_size=100,loss=0,use_htb=True)
net.addLink( s7, s8, 2, 7 ,bw=1,delay='2ms',max_queue_size=100,loss=0,use_htb=True)
net.start()
#net.pingAll()
#add qos
'''
